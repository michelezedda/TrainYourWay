...
const mealStyles = StyleSheet.create({
  ...
  addBadge: { paddingHorizontal: 14, paddingVertical: 10, borderRadius: Radius.xl, backgroundColor: 'rgba(168,85,247,0.12)', borderWidth: 1, borderColor: 'rgba(168,85,247,0.2)' },
  ...
  modeTab: { paddingHorizontal: 14, paddingVertical: 10, borderRadius: Radius.lg, backgroundColor: 'rgba(255,255,255,0.04)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.07)' },
  ...
  foodChip: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 12, paddingVertical: 8, borderRadius: Radius.full, backgroundColor: 'rgba(168,85,247,0.12)', borderWidth: 1, borderColor: 'rgba(168,85,247,0.25)', alignSelf: 'flex-start', maxWidth: '70%' },
